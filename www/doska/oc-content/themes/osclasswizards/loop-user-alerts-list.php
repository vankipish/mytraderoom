                                    ...
                                    <div class="attribute_list"><span class="category"><i
                                        ...
                                        <?php if (osc_price_enabled_at_items()) { ?>
                                            <span class="currency-value"
                                                  style="margin: 0px"><?php echo "Ориентировочная цена заказчика: " . osc_item_formated_price(); ?></span>

                                            <span class="currency-value"
                                                  style="margin: 0px; margin-bottom: 3px"> <?php echo "Минимальная предложенная цена: " . osc_format_min_price(osc_item_min_price()); ?></span>
                                        <?php } ?>
                                    </div>
          ...
          <figure>
            ...
            <?php } ?>
                            ...
                            <div class="col-sm-8 col-md-8" style="margin-left: 5%">
                                <div class="info">
                                    <div class="detail_info">
                                        <h4><a href="<?php echo osc_premium_url(); ?>" class="title"
                                        ...
                                        <div class="attribute_list"><span class="category"><i
                                            ...
                                            <?php if (osc_price_enabled_at_items()) { ?>
                                                ...
                                                <span class="currency-value" style="margin: 0px; margin-bottom: 3px"><i

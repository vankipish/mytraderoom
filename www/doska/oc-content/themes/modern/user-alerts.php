            ...
            <div id="main">
                ...
                <?php } else { ?>
                    <?php while(osc_has_alerts()) { ?>
                        <div class="userItem" >
                            <div><?php _e('Alert', 'modern'); ?> | <a onclick="return confirm('<?php echo osc_esc_js(__('This action can\'t be undone. Are you sure you want to continue?', 'modern')); ?>');" href="<?php echo osc_user_unsubscribe_alert_url(); ?>"><?php _e('Delete this alert', 'modern'); ?></a></div>

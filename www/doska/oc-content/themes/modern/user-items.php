                    ...
                    <?php while(osc_has_items()) { ?>
                            <div class="item" >
                                    ...
                                    <p class="options">
                                        ...
                                        <span>|</span>
                                        <a class="delete" onclick="return confirm('<?php echo osc_esc_js(__('This action can not be undone. Are you sure you want to continue?', 'modern')); ?>')" href="<?php echo osc_item_delete_url();?>" ><?php _e('Delete', 'modern'); ?></a>

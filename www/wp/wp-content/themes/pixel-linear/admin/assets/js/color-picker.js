! function(a, b) {
    var c, d = '<a tabindex="0" class="wp-color-result" />',
    ...
    c = {
        ...
        _create: function() {
            if (a.support.iris) {
                var b = this,
                    c = b.element;
                a.extend(b.options, c.data()), b.close = a.proxy(b.close, b), b.initialValue = c.val(), c.addClass("wp-color-picker").hide().wrap(f), b.wrap = c.parent(), b.toggler = a(d).insertBefore(c).css({
